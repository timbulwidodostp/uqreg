...
{cmd:help rifhdreg}{right: ({browse "https://doi.org/10.1177/1536867X20909690":SJ20-1: st0588})}
{hline}
...
{cmd:_ghvar} in the right folder.  This estimates the half-variance RIF using
the jackknife method.  See the structure of {cmd:_ghvar.ado} as the
template.{p_end}
{phang2}
...
{phang}
Rios-Avila, F. 2019. Recentered influence functions in Stata: Methods for analyzing the determinants of poverty and inequality. Working paper 927, Levy Economics Institute. {browse "http://www.levyinstitute.org/pubs/wp_927.pdf"}.
